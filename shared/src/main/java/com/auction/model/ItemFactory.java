...
public interface ItemFactory {
    Item create(String type, String id, String name, String description, double startingPrice,
    ...
    final class DefaultItemFactory implements ItemFactory {
        ...
        @Override
        public Item create(String type, String id, String name, String description, double startingPrice,
                           double priceStep, LocalDateTime bidStartTime, LocalDateTime bidEndTime,
                           String sellerId, Map<String, Object> attributes) {
            ...
            return switch (type == null ? "Other" : type) {
                ...
                case "Electronics" -> new Electronics(id, name, description, startingPrice, priceStep,
                        bidStartTime, bidEndTime, sellerId, integer(attrs, "wattage"),
                        str(attrs, "origin"), integer(attrs, "warrantyMonths"), str(attrs, "serialNumber"));
                case "Vehicle" -> new Vehicle(id, name, description, startingPrice, priceStep, bidStartTime,
                        bidEndTime, sellerId, integer(attrs, "miles"), date(attrs, "manufacturingDate"),
                        str(attrs, "brand"), str(attrs, "vin"), bool(attrs, "accidentHistory"));
                case "AuctionItem" -> new AuctionItem(id, name, description, startingPrice, priceStep,
