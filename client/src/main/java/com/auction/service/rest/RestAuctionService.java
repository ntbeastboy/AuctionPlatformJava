...
/**
 * Network-backed AuctionService — every action becomes a POST to the matching server endpoint.
 * Scheduling and timer recovery happen on the server, so the client implementation is essentially a
 * thin proxy.
 */
