...
/**
 * Read-only view of items backed by the REST API. Use {@code ItemService} for create/delete and
 * {@code BidService}/{@code AuctionService} for any mutating actions on auctions.
 */
public class RestItemRepository implements ItemRepository {
  ...
  public void update(Item item) {
    throw new UnsupportedOperationException(
        "RestItemRepository is read-only. Mutations happen on the server through service "
            + "endpoints.");
  }
}
