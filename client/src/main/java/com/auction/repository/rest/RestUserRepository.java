...
/**
 * Read-only view of users backed by the REST API. Mutating operations are intentionally unsupported
 * here — the desktop client must mutate users through {@code UserService}/{@code REST} endpoints,
 * never via direct repository writes.
 */
