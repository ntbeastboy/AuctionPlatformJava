...
public class BidController {
  ...
  public void handleGetBidById(Context ctx) {
    ...
    Bid bid = bidRepo.findById(id).orElseThrow(() -> new RuntimeException("Bid not found: " + id));
  ...
  public void handleGetHighestBidForItem(Context ctx) {
    ...
    Bid highest = bids.stream().max(Comparator.comparingDouble(Bid::getAmount)).orElseThrow();
